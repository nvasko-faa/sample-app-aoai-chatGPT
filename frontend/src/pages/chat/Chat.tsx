...
import { CommandBarButton, IconButton, Dialog, DialogType, DialogContent, DialogFooter, Stack, PrimaryButton } from '@fluentui/react'
      ...
      {showAuthMessage ? (
        ...
        <Stack horizontal className={styles.chatRoot}>
          <div className={styles.chatContainer}>
            ...
            >
              <DialogContent>
                <p style={{ fontSize: '20px' }}>{ui?.chat_description}</p>
              </DialogContent>
              <DialogFooter>
            ...
            { !messages || messages.length < 1 ? (
              <Stack className={styles.chatEmptyState}>
                ...
                <p style={{ color: 'red', fontSize: '20px', fontWeight: 'bold' }}>BETA Version</p>
