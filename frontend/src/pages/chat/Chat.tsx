...
import { CommandBarButton, IconButton, Dialog, DialogType, DialogContent, DialogFooter, Stack, PrimaryButton, DefaultButton } from '@fluentui/react'
...
const Chat = () => {
  ...
  // Handle dialog close (user acknowledges)
  const handleDisclaimerClose = () => {
    setShowDisclaimer(false); // Close the dialog
  };

  const dialogTitle = "Welcome to FAA Automated HR Assistance"
  const dialogContent = `
1. **AI-Generated Responses:**  
   This chatbot utilizes generative artificial intelligence (AI) technology to provide answers to human resource (HR) policy-related questions. While the chatbot strives to deliver accurate and timely information, the responses are generated based on patterns in data and do not constitute official HR advice or legally binding guidance.

2. **Non-Binding Information:**  
   The information provided by this chatbot is for general informational purposes only. It may not fully reflect the specific nuances of federal HR policies, rules, or procedures applicable to individual cases. Users should not rely solely on the chatbot’s responses to make decisions that could affect their employment, benefits, or rights. For any complex or specific HR issues, please consult your HR representative or refer to official HR policies and guidelines.

3. **No Warranty:**  
   The agency makes no representations or warranties of any kind, express or implied, regarding the completeness, accuracy, reliability, or availability of the information generated by the AI chatbot. The agency shall not be held responsible for any errors or omissions in the chatbot's responses or for any reliance placed on the information provided.

4. **User Responsibility:**  
   It is the responsibility of each user to verify the chatbot’s responses with the appropriate federal HR officials before taking any action or making decisions based on the information provided. In the event of any conflict between chatbot responses and official HR policy, the official policy documents or guidance from authorized HR personnel shall take precedence.

5. **Data Collection and Privacy:**  
   This chatbot may collect user interactions and related data for the purpose of improving service quality. However, any personally identifiable information (PII) shared during chatbot interactions will be handled in accordance with federal privacy policies and applicable laws. The agency shall take reasonable steps to protect user data, but users are advised not to share sensitive or confidential information during interactions with the chatbot.

6. **Changes and Updates:**  
   The agency reserves the right to update or modify this disclaimer at any time without prior notice. It is recommended that users review this disclaimer regularly for any changes.

By using this chatbot, you acknowledge and agree to the terms of this disclaimer.
`;
        ...
        <Stack horizontal className={styles.chatRoot}>
          <div className={styles.chatContainer}>
            ...
            >
              ...
              <DialogFooter>
                <PrimaryButton onClick={handleDisclaimerClose} text="Acknowledge" />
              </DialogFooter>
            </Dialog>
